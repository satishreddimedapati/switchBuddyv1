...
The response MUST be a single JSON object. This object must contain:
...
3.  **code_snippet**: Provide a clear, simple code example demonstrating the core idea. For this card, you MUST provide 'code' and 'language' properties.
